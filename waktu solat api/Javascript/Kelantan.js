function fetchPrayerTimes() {
    const apiUrl1 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=4.8843&longitude=101.9682&method=2';
    const apiUrl2 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=6.0424&longitude=102.1428&method=2';
    const apiUrl3 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=6.1248&longitude=102.2544&method=2';
    const apiUrl4 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=5.5308&longitude=102.2019&method=2';
    const apiUrl5 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=6.1991&longitude=102.1694&method=2';
