function fetchPrayerTimes() {
    const apiUrl1 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=5.2077&longitude=103.2049&method=2';
    const apiUrl2 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=5.1827&longitude=103.1164&method=2';
    const apiUrl3 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=5.3296&longitude=103.1370&method=2';
    const apiUrl4 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=5.3679&longitude=103.0472&method=2';
