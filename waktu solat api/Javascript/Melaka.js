function fetchPrayerTimes() {
    const apiUrl1 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=2.2711&longitude=102.2887&method=2';
    const apiUrl2 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=2.3822&longitude=102.2116&method=2';
    const apiUrl3 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=2.3113&longitude=102.4309&method=2';
    const apiUrl4 = 'https://api.aladhan.com/v1/hijriCalendar/1437/4?latitude=1.7294&longitude=103.8992&method=2';
